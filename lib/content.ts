...
export const content: Record<Locale, SiteContent> = {
  pt: {
    ...
    hero: {
      ...
      text: "Actuamos através de serviços profissionais, projectos estratégicos e plataformas de inovação para criar valor empresarial, institucional e cultural.",
